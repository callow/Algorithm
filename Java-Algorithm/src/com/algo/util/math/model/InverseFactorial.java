package com.algo.util.math.model;
import java.math.BigInteger;

/**
 * 连续阶乘逆元的线性递推：
 *   - 组合公式 C(n,m) % 1000000007
 * 	 
 *    C(274,489) = 489! / (274!*(489-274)!)
 *
 */
...
//		}
	...
	// 得到的结果 % MOD
	// 阶乘结果逆元表的线性递推
	public static int factorialInverse(int n, int m) {
		long ans = fac[n];
		ans = (ans * inv[m]) % MOD;
		ans = (ans * inv[n - m]) % MOD;
		return (int) ans;
	...
	public static void main(String[] args) {
		...
		System.out.println("方法2答案 : " + factorialInverse(a, b));
	}
